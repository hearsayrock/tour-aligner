-- Ensure the browser may write an authenticated user's acceptance even though
-- legal_document_acceptances intentionally has no direct client INSERT policy.
-- This replays the permission correction in case an earlier deployment applied
-- the original SECURITY INVOKER version of the function but missed its fix.

-- Rollback for 20260731005500_add_past_date_guard_to_booking_rpcs.sql
-- Restores set_contact_thread_working_date and confirm_contact_booking to their
-- pre-guard bodies (the latter as last defined in 20260723225618_auto_create_event_on_booking_confirm.sql).
